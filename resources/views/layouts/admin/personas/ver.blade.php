                            ...
                            <div class="col-xxl-12">
                                ...
                                <select name="ciudad_id" class="form-select border-success-subtle" required>
                                    ...
                                    @foreach ($ciudades as $ciudad)
                                        <option value="{{ $ciudad }}">{{ $ciudad->nombre }}</option>
                                    @endforeach
                                    <!-- Puedes cargar dinámicamente desde el controlador -->
                                </select>
                            </div>
                ...
                <div class="modal-body">
                    <form id="updateForm" action="javascript:void(0);">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-6">
                                <label class="form-label fw-semibold">Carnet</label>
                                <input type="text" id="carnet" name="carnet" class="form-control border-warning-subtle"
                                    placeholder="Ingrese su carnet" required>
                            </div>
                            ...
                            <div class="col-xxl-6">
                                <label class="form-label fw-semibold">Nombres</label>
                                <input type="text" id="nombres" name="nombres" class="form-control border-warning-subtle"
                                    placeholder="Ingrese su nombre" required>
                            </div>
                            ...
                            <div class="col-xxl-6">
                                <label class="form-label fw-semibold">Apellidos</label>
                                <input type="text" id="apellidos" name="apellidos" class="form-control border-warning-subtle"
                                    placeholder="Ingrese sus apellidos" required>
                            </div>
                            ...
                            <div class="col-xxl-6">
                                <label class="form-label fw-semibold">Correo</label>
                                <input type="email" id="correo" name="correo" class="form-control border-warning-subtle"
                                    placeholder="filmo@gmail.com">
                            </div>
                            ...
                            <div class="col-xxl-6">
                                <label class="form-label fw-semibold">Celular</label>
                                <input type="text" id="celular" name="celular" class="form-control border-warning-subtle"
                                    placeholder="Ingrese su número" required>
                            </div>
                            ...
                            <div class="col-xxl-6">
                                <label class="form-label fw-semibold">Dirección</label>
                                <input type="text" id="direccion" name="direccion" class="form-control border-warning-subtle"
                                    placeholder="Ingrese su dirección">
                            </div>
                            ...
                            <div class="col-xxl-12">
                                <label class="form-label fw-semibold">Seleccione Ciudad</label>
                                <select id="ciudad_id" name="ciudad_id" class="form-select border-warning-subtle" required>
                                    <option value="" selected disabled>Seleccione una ciudad</option>
                                    @foreach ($ciudades as $ciudad)
