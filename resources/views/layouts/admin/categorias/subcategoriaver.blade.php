        ...
        <div class="col-xl-4">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <a href="#" class="btn btn-success btn-icon waves-effect waves-light"
                        title="Ir a detalles del producto" data-bs-toggle="modal" data-bs-target=".bs-edit-modal-dialog">
            ...
            <div class="card product">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('admin.productos.vertodos', ['id' => $subcategoria->id]) }}" class="btn btn-primary btn-icon waves-effect waves-light"
                        title="Ir a detalles del producto">
                        <i data-feather="eye"></i>
                    </a>
                    @if(isset($subcategoria['categorias_hijos'][0]))
                        <a href="{{ route('admin.categorias.subcategorias.ver', ['id' => $subcategoria->id]) }}" class="btn btn-danger btn-icon waves-effect waves-light"
