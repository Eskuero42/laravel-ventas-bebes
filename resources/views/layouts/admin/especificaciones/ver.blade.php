                                ...
                                <div>
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                        id="create-btn" data-bs-target="#exampleModalgrid"><i
                                            class="ri-add-line align-bottom me-1"></i> Registrar Especificaciones</button>
                                </div>
                            </div>
                            <div class="col-sm">
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            <table class="table align-middle table-nowrap" id="customerTable">
                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($especificaciones as $n => $especificacion)
                                        <tr>
                                            <td>{{ $n + 1 }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <button class="btn btn-sm btn-danger remove-item-btn deleteBtn"
                                                        data-bs-id="{{ $especificacion->id }}" data-bs-toggle="modal"
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    ...
                                    <input type="text" name="descripcion" class="form-control border-success-subtle"
                                        id="firstName" placeholder="Ingrese su descripción" required>
                                </div>
                            </div>
                            <div class="col-xxl-12">
                                <label for="tipo_id" class="form-label fw-semibold">Seleccione Tipo</label>
                                <select name="tipo_id" class="form-select form-select border-success-subtle" required>
